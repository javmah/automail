...
class Automail_Public {
	...
	*/
	public function enqueue_styles(){
		 ...
		 * The Automail_Loader will then create the relationship between the defined hooks and the functions defined in this class.
		*/
	...
	*/
	public function enqueue_scripts(){
		 ...
		 * The Automail_Loader will then create the relationship between the defined hooks and the functions defined in this class.
		*/
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/automail-public.js', array( 'jquery' ), $this->version, false );
	}
